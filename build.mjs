...
`;
writeFileSync(join(here, 'roles.js'), js);

console.log(`@eq-solutions/roles v${model.version} built: ${roleKeys.length} roles, ${permKeys.length} permissions -> roles.ts + roles.js + roles.json`);
